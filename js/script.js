...
function modal(i) {
    ...
    inject.innerHTML = `<iframe id="myVideo" width="560" height="315" src="${movies[i].link}" title="${movies[i].title}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" style="display:absolute; top: 5vh; left: 5vw"></iframe>`;
